...
public class ConnectionService {
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    String temperature = webService.makeRequest(url, ServiceHandler.GET, 0);
                    HashMap<String, Integer> response = new HashMap<>();
                    response.put("temperature", temperature != null ? Integer.valueOf(temperature) : 0);
    ...
    public void setTemperature(final int temperature, final int roomNumber) {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    String url = baseUrl + "/rooms/" + roomNumber + "/temperature";
                    webService.makeRequest(url, ServiceHandler.POST, temperature);
     ...
     * @param roomNumber number of room, from which value will be gained
     * @param handler    handler to obtain result asynchronously. When no error occurs - onResponseReceived invoked with
     *                   HashMap as argument. HashMap contains only one key: "windows-open". When value of this key is
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    String isOpen = webService.makeRequest(url, ServiceHandler.GET, 0);
                    HashMap<String, Integer> response = new HashMap<>();
                    response.put("windows-open", isOpen != null ? Integer.valueOf(isOpen) : 0);
                    handler.onResponseReceived(response);
                } catch (Exception e) {
                    Log.d(TAG, e.getMessage());
                    handler.onError(e.getMessage());
    ...
    public void setWindowsStatus(final boolean setOpen, final int roomNumber) {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    String url = baseUrl + "/rooms/" + roomNumber + "/windows";
                    webService.makeRequest(url, ServiceHandler.POST, setOpen ? 1 : 0);
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    String isOpen = webService.makeRequest(url, ServiceHandler.GET, 0);
                    HashMap<String, Integer> response = new HashMap<>();
                    response.put("doors-open", isOpen != null ? Integer.valueOf(isOpen) : 0);
                    handler.onResponseReceived(response);
                } catch (Exception e) {
                    Log.d(TAG, e.getMessage());
                    handler.onError(e.getMessage());
    ...
    public void setDoorsStatus(final int setOpen, final int roomNumber) {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    String url = baseUrl + "/rooms/" + roomNumber + "/doors";
                    webService.makeRequest(url, ServiceHandler.POST, setOpen);
                    Log.d(TAG, "Windows status changed: " + setOpen);
                } catch (Exception e) {
                    Log.d(TAG, e.getMessage());
                }
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    ...
                    String isOn = webService.makeRequest(url, ServiceHandler.GET, 0);
                    HashMap<String, Integer> response = new HashMap<>();
                    response.put("lights-turnedON", isOn != null ? Integer.valueOf(isOn) : 0);
                    handler.onResponseReceived(response);
                } catch (Exception e) {
                    Log.d(TAG, e.getMessage());
                    handler.onError(e.getMessage());
    ...
    public void setLightsStatus(final int setON, final int roomNumber) {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    String url = baseUrl + "/rooms/" + roomNumber + "/lights";
                    webService.makeRequest(url, ServiceHandler.POST, setON);
    ...
    public void requestRoomList(final ResponseHandler handler) {
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... params) {
                try {
                    String url = baseUrl + "/rooms";
                    String json = webService.makeRequest(url, ServiceHandler.GET, 0);
    ...
    private class ServiceHandler {
        ...
        public String makeRequest(String url, String method, int value) throws Exception {
